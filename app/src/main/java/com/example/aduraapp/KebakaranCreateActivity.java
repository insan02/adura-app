...
import com.example.aduraapp.databinding.ActivityKebakarancreateBinding;
...
public class KebakaranCreateActivity extends AppCompatActivity {

    private ActivityKebakarancreateBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityKebakarancreateBinding.inflate(getLayoutInflater());
        ...
        binding.btnkirim.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (kolomketerangan.isEmpty() || kolomtanggalkejadian.isEmpty() || kolomnomorpelapor.isEmpty() || kolomlokasikejadian.isEmpty() || kolomnamapelapor.isEmpty()) {
                    Toast.makeText(KebakaranCreateActivity.this, "Harap isi semua data", Toast.LENGTH_SHORT).show();
                } else {
                    if (!isValidDate(kolomtanggalkejadian)) {
                        Toast.makeText(KebakaranCreateActivity.this, "Format tanggal tidak valid. Harap sesuaikan dengan format DD-MM-YYYY", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    db = FirebaseDatabase.getInstance();
                    reference = db.getReference("Laporan_kebakaran");
                    ...
                    reference.child(idUser).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        private void saveImageToStorage(Uri imageUri, String key) {
                            ...
                            uploadTask.addOnSuccessListener(taskSnapshot -> {
                                ...
                                Toast.makeText(KebakaranCreateActivity.this, "Gagal Mengunggah gambar", Toast.LENGTH_SHORT).show();
                            });
                        }
                        ...
                        private void resetForm() {
                            ...
                            Toast.makeText(KebakaranCreateActivity.this, "Laporan Terkirim", Toast.LENGTH_SHORT).show();
                            ...
                            Intent intent = new Intent(KebakaranCreateActivity.this, KebakaranRiwayatList.class);
                            startActivity(intent);
                        }

                        @Override
                        public void onCancelled(DatabaseError databaseError) {
                            Toast.makeText(KebakaranCreateActivity.this, "Error Dalam Pengiriman Data", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
