...
public class KebakaranAdminDetailRiwayatActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kebakaranadmindetailriwayat);
        ...
        reference = db.getReference("Laporan_kebakaran").child(idUser).child(nextIdLaporan);
        ...
        if ("Verified".equals(status) || "Rejected".equals(status)) {
            ...
            btnterima.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(KebakaranAdminDetailRiwayatActivity.this);
                            ...
                            reference.child("status").setValue("Verified")
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            Toast.makeText(KebakaranAdminDetailRiwayatActivity.this, "Status diterima", Toast.LENGTH_SHORT).show();
                                            // Sembunyikan tombol setelah status diterima
                                            btnterima.setVisibility(View.GONE);
                                            btntolak.setVisibility(View.GONE);

                                            Intent intent = new Intent(KebakaranAdminDetailRiwayatActivity.this, KebakaranAdminRiwayatList.class);
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            ...
                                            Toast.makeText(KebakaranAdminDetailRiwayatActivity.this, "Gagal mengupdate status: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                    });
                            ...
                            reference.child("status").setValue("Rejected")
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            ...
                                            Toast.makeText(KebakaranAdminDetailRiwayatActivity.this, "Status ditolak", Toast.LENGTH_SHORT).show();
