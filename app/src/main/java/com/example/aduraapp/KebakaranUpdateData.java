...
public class KebakaranUpdateData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kebakaranupdatedata);
...
//        idlaporan
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (!isDestroyed() && !isFinishing()) {
                        Glide.with(KebakaranUpdateData.this)
                                .load(imageUrl)
                                .fitCenter()
                                .into(imageView);}
                        ...
                        imageRef.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            reference.setValue(data)
                                    .addOnSuccessListener(aVoid -> {
                                        ...
                                        Intent intent = new Intent(KebakaranUpdateData.this, KebakaranRiwayatList.class);
    ...
    private void checkLocationPermission() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED){
            tipe_laporan = "KebakaranUpdate";
            Intent intent = new Intent(KebakaranUpdateData.this, MapsActivity.class);
